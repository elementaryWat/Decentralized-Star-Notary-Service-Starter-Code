 ...
 */
 ...
 //
 // const fs = require('fs');
 const mnemonic = "view nephew ribbon tone alpha clip smart hope mandate wish cabbage drum";
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () => new HDWalletProvider(mnemonic, `https://rinkeby.infura.io/v3/088fc3da350c40d8b61fa46ee3b56116`),
